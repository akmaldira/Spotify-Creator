...
echo "Spotify creator\n";
echo "Recode by Diraaaaa\n";
echo "\nTanpa @\nEmail : ";
...
for ($i = 4; $i <= $jmlh ; $i++) {
	...
	curl_setopt($ch, CURLOPT_POSTFIELDS, "email=$email&password_repeat=$pass&password=$pass&key=142b583129b2df829de3656f9eb484e6&gender=male&platform=Android-ARM&creation_point=client_mobile&birth_day=04&birth_month=6&iagree=true&app_version=849800892&birth_year=2001&displayname=$name");
